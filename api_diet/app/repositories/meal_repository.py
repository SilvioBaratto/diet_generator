...
from app.models import Meal, MealIngredient, Ingredient, MealType, GroceryList, GroceryListItem
...
class IngredientRepository:
    ...
    def create_ingredient(self, ingredient_id: str, name: str, unit: str) -> Ingredient:
