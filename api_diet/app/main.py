"""FastAPI application factory for Diet Generator API"""

# Load environment variables FIRST, before any other imports
# This ensures BAML and other libraries can access env vars
...
def create_application() -> FastAPI:
    ...
    app = FastAPI(
        ...
        openapi_url="/openapi.json" if (settings.debug or settings.is_staging) else None,  # Keep OpenAPI JSON accessible
    ...
    async def deep_health_check():
        ...
        try:
            ...
            fly_info = {
                ...
                "app_name": os.getenv("FLY_APP_NAME", "scuolazoo-fantasy-api"),
